            ...
            <DialogPanel
              className={cn(
                ...
                `inline-block w-full scale-100 rounded-xl  bg-white text-left align-bottom shadow-xl transition-all dark:bg-gray-800 sm:my-8 sm:align-middle relative ${
                  animationType === 'scale' ? 'scale-100' : animationType
                } `
              )}
            >
              {title && (
              ...
              {/* <button
                type='button'
                className='rounded-full p-3 bg-white  text-gray-800 hover:bg-gray-200 dark:text-gray-100 dark:hover:bg-gray-700 absolute -top-11 -right-3'
                onClick={onClose}
              >
