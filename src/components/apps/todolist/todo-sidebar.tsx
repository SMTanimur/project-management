...
const TodoSidebar: FC<ITodoSidebarProps> = ({
  ...
  return (
    <div
      className={`panel absolute z-10 hidden h-full w-[240px] max-w-full flex-none space-y-4 p-4 rounded-r-none rtl:rounded-l-none xl:relative xl:block xl:h-auto xl:rounded-r-md rtl:xl:rounded-l-md ${
