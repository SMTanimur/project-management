    ...
    <CardContent className="pb-0 px-0 flex flex-col">
      <div className="flex items-center gap-3 justify-between px-4">
        ...
        <div className="flex flex-col flex-1 mr-5">
          <h3 className="text-lg text-gray-900 font-semibold">{node?.data?.label}</h3>
          {node?.description && <p className="text-gray-600 text-sm w-[150px]">{node?.description}</p>}
        </div>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This action cannot be undone. This will permanently delete this building block and remove
                          your data.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel className="py-1 rounded-md">Cancel</AlertDialogCancel>
                        <AlertDialogAction className="py-1 rounded-md" onClick={() => onNodeDeleteClick(node.id)}>
                          Confirm
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
