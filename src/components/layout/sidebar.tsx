...
const Sidebar = () => {
  ...
  return (
    <div className=''>
      <nav
        className={cn(
          'sidebar fixed bottom-0 top-0 z-[999] bg-white h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300',
          openSidebar && 'sidebar-collapsed'
        )}
      >
